...
//           <button onClick={handlePrev} className="absolute top-1/2 left-4 transform -translate-y-1/2 text-white text-2xl" >
//             {"<"}
//           </button>
//           <button onClick={handleNext}  className="absolute top-1/2 right-4 transform -translate-y-1/2 text-white text-2xl" >
//             {">"}
//           </button>
//           <button onClick={handleCloseModal} className="absolute top-4 right-4 text-white text-2xl" >
//             &times;
//           </button>
...
//               <p className="text-white text-sm day-position1">On the Special day</p>
//             </div>
//           </div>
//         </div>
//       )}
...
//         <OwlCarousel className="owl-theme pt-5 ps-5 rounded shadow" {...options} >
...
//                     <div className="overlay-text absolute left-0 bottom-0 right-0 order bg-black bg-opacity-70 p-4 rounded" style={{ height: "10px", width: "228px" ,bottom:"19px"}} >
